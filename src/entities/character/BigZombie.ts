...
export class BigZombie implements Character {
    // Physical properties
    private _size: Vec2;
    public pos: Vec2;
    public vel: Vec2;
    ...
    constructor(pos: Vec2) {
        ...
        this.sprite = sprite;
        this._loaded = new Promise((resolve) => { (this.sprite as HTMLImageElement).onload = resolve; }).then(() => { sprite.width = 24; sprite.height = 24; });
    }
