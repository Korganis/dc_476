...
import Fists from "../../weapons/Melee/Fists";
import { Weapon } from "../../weapons/Weapon";
import { EnemyPathfinding } from "../behaviour/EnemyPathfinding";
import Character from "./Character";

export class Slime implements Character {
    // Physical properties
    private _size: Vec2;
    public pos: Vec2;
    public vel: Vec2;
