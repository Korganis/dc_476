...
class Poof implements Entity {
    ...
    constructor(pos: Vec2) {
        ...
        if (frames.length === 0) {
            for (let i = 0; i < 4; i++) {
                ...
                frames[i].src = `./assets/img/entities/poof/${i}.png`;
    ...
    draw(): HTMLImageElement {
        ...
        let frame = (this.lifetime * TICKRATE_N) >> 6n;
        return frames[frame as unknown as number]; // This works, you can actually use bigint as an index
    }
}
